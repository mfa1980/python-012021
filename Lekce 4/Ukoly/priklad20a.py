...
nebo adresy, když chceme vyzkoušet, jestli náš program funguje. Jindy třeba potřebujeme nějaká data anonymizovat,
tj. odebrat z nich citlivé osobní údaje jako jména, adresy atd. Pro tento účel existuje modul Faker, která nám
umí vygenerovat jména, adresy a řadu dalších dat, které můžeme využít při testování našich programů.
...
generator_falesnych_dat třídy Faker. Využijeme parametr "cs_CZ", který řekne modulu, aby nám generoval
česká jména a adresy. Objekt generator_falesnych_dat má naprogramované funkce jako name() pro vygenerování
náhodného jména, address pro vygenerování náhodné adresy atd.
