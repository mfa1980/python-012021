"""
Morseova abeceda
Ve slovníku níže vidíš Morseovu abecedu, kde jako klíč slouží znak v klasické abecedě a jako hodnota
zápis znak v Morseově abecedě.
...
Na začátku uvažuj i to, že uživatel nezadává mezery. Projdi řetězec zadaný uživatelem.
Najdi každý znak ve slovníku a vypiš ho na obrazovku v Morseově abecedě.
...
text = input("Zadej text, který chceš přepsat do Morseovy abecedy: ")
text = list(text)
print (text)
for znak in text:
  if znak == " ":
